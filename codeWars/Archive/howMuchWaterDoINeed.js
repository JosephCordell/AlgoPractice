...
For example, if the amount of clothes is 14, the amount of water it requires is 5 and the load is 10, then you need 5 * 1.1 ^ (14 - 10) amount of water.
...
let water = 10, load = 10, clothes = 20

console.log(howMuchWater(water, load, clothes));